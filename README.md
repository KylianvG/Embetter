...
Several pre-trained embeddings are provided and are automatically downloaded upon creating a `WordEmbedding` object with the name of one of the available embeddings. The embeddings are based on <a href="https://code.google.com/archive/p/word2vec/" target="_blank">word2vec</a>, <a href="https://nlp.stanford.edu/projects/glove/" target="_blank">GloVe</a>, and <a href="https://fasttext.cc/" target="_blank">fastText</a>.
